<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bo.aspx.cs" Inherits="system_valueObject" %>
...
function autoname(v)
{
	...
	var _voname = document.getElementById("voname");
	var _filename = document.getElementById("filename");
	_voname.value = b.join("")+"VO";
	_filename.value = b.join("")+"BO";
...
<div style="width:500px; margin:auto; margin-top:2%;">
    <div style="padding:20px; font-size:22px; background-color:#c81623; color:#fff;">Platform<span style="float:right;">Business Object</span></div>
    <div style="background-color:#f8f8f8; padding:50px;">
        <form id="Form1" name="myform" runat="server" method="post" onSubmit="return Checkform(this);">
        	...
        	<div style="padding:10px 0px 5px 0px;">对应的VO名</div>
            <div><input name="voname" type="text" id="voname" style="width:100%;" value="VO"></div>
            
            <div style="padding:10px 0px 5px 0px;">生成文件名</div>
            <div><input name="filename" type="text" id="filename" style="width:100%;" value="BO"></div>
            ...
            <div style="padding:20px 0px 0px 0px;"><asp:Button ID="add" OnClick="click_add" runat="server" Text="确定创建 BO" CssClass="button_submit"/></div>
    		<div style="padding:20px 0px 0px 0px; text-align:center;"><a href="vo.aspx">前往VO文件创建</a></div>
      </form>
    </div>
</div>
